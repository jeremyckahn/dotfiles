DOTFILE_TARGET = $$HOME
DOTFILE_PACKAGES = bash vim tmux linux lazygit btop gh-dash zed
...
tools.linux:
	sudo apt install gawk net-tools coreutils wl-clipboard luarocks


tools.macos:
	brew install gawk coreutils luarocks
